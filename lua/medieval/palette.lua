...
M.palette = {
  -- basementBlue = "#1B1C1D", -- BG
  -- basementBlue = "#20212B", -- BG
  basementBlue = "#191A22", -- BG
  basicallyBlack = "#191919", -- CursorLine
