...
M.setup = function()
  ...
  local groups = {
    ...
    CursorLine = { bg = palette.basementBlue },
    ...
    SignColumn = config.transparent_mode and { bg = nil } or { bg = palette.basementBlue }, --@Link
